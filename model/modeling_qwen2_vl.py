...
class Qwen2VLForConditionalGeneration(Qwen2VLPreTrainedModel, GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        if generation_mode == GenerationMode.ASSISTED_GENERATION:
            ...
            result = self._sample_text_bias_calibration(
                input_ids,
                logits_processor=prepared_logits_processor,
                stopping_criteria=prepared_stopping_criteria,
                generation_config=generation_config,
    ...
    def _sample_text_bias_calibration(
        self,
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            # Text-bias calibration
            bsz = next_token_logits.shape[0] // 2
            next_token_logits[:bsz] = next_token_logits[:bsz] + scale * (next_token_logits[:bsz] - next_token_logits[bsz:])
            ...
            # Copy the generated tokens to the without-image parts
            next_tokens[bsz:] = next_tokens[:bsz]
